        ...
        return (
            <section>
                ...
                <ul className="contact">
                    <li className="icon solid fa-envelope"><a href="mailto:ivan.a.neto@hotmail.com">ivan.a.neto@hotmail.com</a></li>
                    ...
                    <li className="icon fa-file"><a href="https://docs.google.com/document/d/1WJInUWfr5vqFRe2XMcU9oozOaHX8jTv-4adBut4mvHQ/edit?usp=sharing">Resume</a><br /></li>
                </ul>
            </section>
        );
    }
