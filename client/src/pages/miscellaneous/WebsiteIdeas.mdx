...
<DropDownSection title={"Hidden idea - Markdown Support"}>
...
<DropDownSection title={"Hidden idea - Mobile Responsiveness"}>
...
<DropDownSection title={"Hidden idea - Emojis"}>
...
<DropDownSection title={"Hidden idea - Drop-down"}>
...
<DropDownSection title={"Hidden idea - Contents Section"}>
...
<DropDownSection title={"Hidden idea - Image Responsiveness"}>
...
## Idea 8 (11/29/2024)
<DropDownSection title={"Hidden idea"}>
Improve the banner. Let's be honest, it's not just good as of today. I have to improve it:

1. Make it prettier, better the content, maybe different image or no image at all (done as of 03/25/2025).
</DropDownSection>
...
## <s>Idea 9 (2/25/2025)</s>

<DropDownSection title={"Hidden idea - AWS S3 Image Storage"}>
...
## <s>Idea 10 (2/25/2025)</s>

<DropDownSection title={"Hidden idea - AWS CDK for Infrastructure"}>
...
<DropDownSection title={"Hidden idea - Automate page metadata"}>
After setting up automatic `server/valley` routes, I find these articles really boring because with my current setup I cannot add text to the articles. I need to find a way to:

1. <s>Automate routes for each article</s>
2. <s>Automate making cards at each node</s>
3. Automate putting images (with any name) in a gallery-type display
