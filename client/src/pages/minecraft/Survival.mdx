...
<div className="halfgriditem emphasis4 dark card">
	### World Map
	<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/world/worldmap.png" alt="" width="70%"></img>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Main tower
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/potatofarm/downup.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Main tower from far away
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/potatofarm/far.png" alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### What a tower room looks like
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/potatofarm/close.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Storage system 
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/potatofarm/storage.png" alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Spawn platform
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/endermanfarm/topclose.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Kill room / Collection Area
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/endermanfarm/bottomclose.png" alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/endermanfarm/topfar.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Fall tower
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/endermanfarm/bottomup.png" alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/ironfarm/far.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Collection area
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/ironfarm/hoppers.png" alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Storage system
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/ironfarm/storage.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Design
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/ironfarm/upclose.png" alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/drownedfarm/far.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Under the water 🥶
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/drownedfarm/bottom.png" alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Collection area
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/drownedfarm/collection.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Spawn area
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/drownedfarm/inside.png" alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Main hall
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/enchantedbooks/hall.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Traders
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/enchantedbooks/villagers.png" alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Where they sleep
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/enchantedbooks/beds.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Good prices
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/enchantedbooks/trading.png" alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Fall tower
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/creeperfarm/downup.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Spawn area
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/creeperfarm/upclose1.png" alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Dark spawn area
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/creeperfarm/upclose2.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/creeperfarm/far.png" alt="" width="70%"></img>
	</div>
</div>
...
<div className="emphasis4 dark card">
	<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/netherhighway/highway.png" alt="" width="70%"></img>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Villagers
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/villagers/villagers.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Breeder
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/villagers/breeder1.png" alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Village Far View
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/villagers/village.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Village Close View
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/villagers/village2.png" alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Main Entrance
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/house/main_entrance.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Back Entrance
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/house/back_entrance.png" alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Second Main Entrance
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/house/main_entrance2.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Far View
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/house/outer.png" alt="" width="70%"></img>
	</div>
</div>
...
<div className="emphasis4 dark card">
	...
	<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/house/inner1.png" alt="" width="70%"></img>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### First Room
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/house/inner2.png" alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Second Room
		<img className="articleImage" src="https://d3otrhxcw2ss5z.cloudfront.net/minecraft/house/storage.png" alt="" width="70%"></img>
	</div>
</div>
