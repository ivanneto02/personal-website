...
import { HalfContainer, OptimizedImage } from "@components"
...
<div className="halfgriditem emphasis4 dark card">
	### World Map
	<OptimizedImage className="articleImage" src={getImageUrl("minecraft/world/worldmap.png")} alt="" />
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Main tower
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/potatofarm/downup.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Main tower from far away
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/potatofarm/far.png")} alt="" />
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### What a tower room looks like
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/potatofarm/close.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Storage system 
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/potatofarm/storage.png")} alt="" />
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Spawn platform
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/endermanfarm/topclose.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Kill room / Collection Area
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/endermanfarm/bottomclose.png")} alt="" />
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/endermanfarm/topfar.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Fall tower
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/endermanfarm/bottomup.png")} alt="" />
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/ironfarm/far.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Collection area
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/ironfarm/hoppers.png")} alt="" />
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Storage system
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/ironfarm/storage.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Design
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/ironfarm/upclose.png")} alt="" />
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/drownedfarm/far.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Under the water 🥶
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/drownedfarm/bottom.png")} alt="" />
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Collection area
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/drownedfarm/collection.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Spawn area
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/drownedfarm/inside.png")} alt="" />
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Main hall
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/enchantedbooks/hall.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Traders
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/enchantedbooks/villagers.png")} alt="" />
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Where they sleep
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/enchantedbooks/beds.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Good prices
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/enchantedbooks/trading.png")} alt="" />
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Fall tower
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/creeperfarm/downup.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Spawn area
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/creeperfarm/upclose1.png")} alt="" />
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Dark spawn area
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/creeperfarm/upclose2.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/creeperfarm/far.png")} alt="" />
	</div>
</div>
...
<div className="emphasis4 dark card">
	<OptimizedImage className="articleImage" src={getImageUrl("minecraft/netherhighway/highway.png")} alt="" />
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Villagers
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/villagers/villagers.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Breeder
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/villagers/breeder1.png")} alt="" />
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Village Far View
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/villagers/village.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Village Close View
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/villagers/village2.png")} alt="" />
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Main Entrance
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/house/main_entrance.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Back Entrance
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/house/back_entrance.png")} alt="" />
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Second Main Entrance
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/house/main_entrance2.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Far View
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/house/outer.png")} alt="" />
	</div>
</div>
...
<div className="emphasis4 dark card">
	...
	<OptimizedImage className="articleImage" src={getImageUrl("minecraft/house/inner1.png")} alt="" />
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### First Room
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/house/inner2.png")} alt="" />
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Second Room
		<OptimizedImage className="articleImage" src={getImageUrl("minecraft/house/storage.png")} alt="" />
	</div>
</div>
