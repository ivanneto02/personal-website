...
<div className="halfgriditem emphasis4 dark card">
	### World Map
	<img className="articleImage" src={getImageUrl("minecraft/world/worldmap.png")} alt="" width="70%"></img>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Main tower
		<img className="articleImage" src={getImageUrl("minecraft/potatofarm/downup.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Main tower from far away
		<img className="articleImage" src={getImageUrl("minecraft/potatofarm/far.png")} alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### What a tower room looks like
		<img className="articleImage" src={getImageUrl("minecraft/potatofarm/close.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Storage system 
		<img className="articleImage" src={getImageUrl("minecraft/potatofarm/storage.png")} alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Spawn platform
		<img className="articleImage" src={getImageUrl("minecraft/endermanfarm/topclose.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Kill room / Collection Area
		<img className="articleImage" src={getImageUrl("minecraft/endermanfarm/bottomclose.png")} alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<img className="articleImage" src={getImageUrl("minecraft/endermanfarm/topfar.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Fall tower
		<img className="articleImage" src={getImageUrl("minecraft/endermanfarm/bottomup.png")} alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<img className="articleImage" src={getImageUrl("minecraft/ironfarm/far.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Collection area
		<img className="articleImage" src={getImageUrl("minecraft/ironfarm/hoppers.png")} alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Storage system
		<img className="articleImage" src={getImageUrl("minecraft/ironfarm/storage.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Design
		<img className="articleImage" src={getImageUrl("minecraft/ironfarm/upclose.png")} alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<img className="articleImage" src={getImageUrl("minecraft/drownedfarm/far.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Under the water 🥶
		<img className="articleImage" src={getImageUrl("minecraft/drownedfarm/bottom.png")} alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Collection area
		<img className="articleImage" src={getImageUrl("minecraft/drownedfarm/collection.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Spawn area
		<img className="articleImage" src={getImageUrl("minecraft/drownedfarm/inside.png")} alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Main hall
		<img className="articleImage" src={getImageUrl("minecraft/enchantedbooks/hall.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Traders
		<img className="articleImage" src={getImageUrl("minecraft/enchantedbooks/villagers.png")} alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Where they sleep
		<img className="articleImage" src={getImageUrl("minecraft/enchantedbooks/beds.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Good prices
		<img className="articleImage" src={getImageUrl("minecraft/enchantedbooks/trading.png")} alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Fall tower
		<img className="articleImage" src={getImageUrl("minecraft/creeperfarm/downup.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Spawn area
		<img className="articleImage" src={getImageUrl("minecraft/creeperfarm/upclose1.png")} alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Dark spawn area
		<img className="articleImage" src={getImageUrl("minecraft/creeperfarm/upclose2.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Far view
		<img className="articleImage" src={getImageUrl("minecraft/creeperfarm/far.png")} alt="" width="70%"></img>
	</div>
</div>
...
<div className="emphasis4 dark card">
	<img className="articleImage" src={getImageUrl("minecraft/netherhighway/highway.png")} alt="" width="70%"></img>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Villagers
		<img className="articleImage" src={getImageUrl("minecraft/villagers/villagers.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Breeder
		<img className="articleImage" src={getImageUrl("minecraft/villagers/breeder1.png")} alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Village Far View
		<img className="articleImage" src={getImageUrl("minecraft/villagers/village.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Village Close View
		<img className="articleImage" src={getImageUrl("minecraft/villagers/village2.png")} alt="" width="70%"></img>
	</div>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Main Entrance
		<img className="articleImage" src={getImageUrl("minecraft/house/main_entrance.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Back Entrance
		<img className="articleImage" src={getImageUrl("minecraft/house/back_entrance.png")} alt="" width="70%"></img>
	</div>
</div>
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### Second Main Entrance
		<img className="articleImage" src={getImageUrl("minecraft/house/main_entrance2.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Far View
		<img className="articleImage" src={getImageUrl("minecraft/house/outer.png")} alt="" width="70%"></img>
	</div>
</div>
...
<div className="emphasis4 dark card">
	...
	<img className="articleImage" src={getImageUrl("minecraft/house/inner1.png")} alt="" width="70%"></img>
</div>
...
<div className="halfgrid">
	<div className="halfgriditem emphasis4 dark card">
		### First Room
		<img className="articleImage" src={getImageUrl("minecraft/house/inner2.png")} alt="" width="70%"></img>
	</div>
	<div className="halfgriditem emphasis4 dark card">
		### Second Room
		<img className="articleImage" src={getImageUrl("minecraft/house/storage.png")} alt="" width="70%"></img>
	</div>
</div>
